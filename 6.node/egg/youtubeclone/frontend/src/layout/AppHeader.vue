    ...
    <div class="sc-AxhUy JixXX">
        ...
        <ul>
            <template v-if="user">
                <li>
                    <div>
                        <label for="video-upload" @click="isUploadShow = true">
                            <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" height="27" width="27"
                ...
                <li>
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" height="27"
                        fill="#FFF" width="27">
                        <g>
                            <path
...
const user = computed(() => userStore.storeUser)
</script>